...
def generate_bbox_with_jitter(detection_azimuth, cam_center_azimuth, FOV, base_conf=0.8, jitter_ratio=0.1):
    """
    Generate a bounding box around a detection azimuth with optional random jitter on width,
    ...
    Args:
        ...
        jitter_ratio (float): Maximum percentage of bbox width to use as jitter (default 10%)
    ...
    jitter = bbox_width * jitter_ratio * (2 * np.random.rand() - 1)  # Random in [-jitter, +jitter]
